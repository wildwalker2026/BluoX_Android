    ...
    function renderSkillsList() {
        ...
        try {
            ...
            if (!skills || skills.length === 0) {
                notebookList.innerHTML = '<div style="padding:32px 16px;text-align:center;color:var(--text-secondary,#888);font-size:14px;">暂无 Skill<br><span style="font-size:12px;">请将 skill 放入数据目录下的 Skills/ 子目录</span></div>';
                return;
            }
